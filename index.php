...
if (!isset($_SESSION['estoque'])) {
    $_SESSION['estoque'] = ESTOQUE_INICIAL; // Inicializando o estoque a partir da configuração
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['comprar']) && $_SESSION['estoque'] > 0) {
        ...
        // Após confirmar a compra, redireciona para a página de agradecimento
        header('Location: obrigado.php');
        exit;
    } elseif (isset($_POST['comprar']) && $_SESSION['estoque'] <= 0) {
        // Se por algum motivo o formulário for enviado sem estoque, manda para esgotado
...
<body>
  ...
  <section id="sobre" class="hero">
    <div>
      ...
      <p>Edição limitada com apenas <?php echo ESTOQUE_INICIAL; ?> unidades. Um item de colecionador para desenvolvedores e fãs da cultura dev.</p>
  ...
  <section id="comprar" class="comprar">
    ...
    <p><strong><?php echo PRECO_PRODUTO; ?></strong> — em até 2x sem juros. Frete grátis para todo Brasil.</p>
